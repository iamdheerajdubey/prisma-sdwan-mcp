...
EXPECTED_SIGNATURES = {
    ...
    "get_flows": ({"app", "cursor", "element_id", "hours", "limit", "page", "path_id", "raw", "site_id", "waninterface_id"}, {"site_id"}),
    "get_link_metrics": ({"element_id", "hours", "raw", "site_id"}, {"site_id"}),
    "get_probe_metrics": ({"hours", "site_id"}, {"site_id"}),
    ...
    "get_basenet_topology": ({"cursor", "limit", "site_id"}, {"site_id"}),
}
