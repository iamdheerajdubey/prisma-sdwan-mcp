...
async function updateStatus() {
  ...
  try {
    ...
    title.textContent = mode === "demo" ? "Preview environment" : status.connected ? "MCP session connected" : "MCP session disconnected";
    meta.textContent = mode === "demo" ? "No live calls in Preview" : status.connected ? `${status.tool_count} tools available` : (status.error || "Not connected");
